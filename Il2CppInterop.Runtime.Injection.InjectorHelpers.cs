...
namespace Il2CppInterop.Runtime.Injection
{
    internal static unsafe class InjectorHelpers
    {
        ...
        internal static IntPtr GetIl2CppExport(string name)
        {
            ...
            {
                throw new NotSupportedException($"Couldn't find {name}({IL2CPP.Fake2TrueName[name]}) in {Il2CppModule.ModuleName}'s exports");
            }
        ...
        {
            if(IL2CPP.Fake2TrueName.TryGetValue(name,out string ret))
            {
                return NativeLibrary.TryGetExport(Il2CppHandle, ret, out address);
            }
            else
            {
                address = IntPtr.Zero;
